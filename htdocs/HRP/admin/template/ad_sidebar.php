...
<html lang="en">
<?php 
include("clsad/clsadmin.php");
$admin = new Admin;
$id = $_SESSION["id"];
$employee_data=$admin->get_info("SELECT *
FROM employees 
  ...
  <aside class="left-sidebar">
    ...
    <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
        ...
        <button class="nav-link sidebartoggler nav-icon-hover custom-toggler" id="headerCollapse" onclick="toggleSidebar()">
